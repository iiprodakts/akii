...
List.prototype.createTiled = function (itemData, options) {
  ...
  if (options.cols === 2) {
    ...
    if (itemData !== null) {
      ...
      console.log(lst); //  sb.sb_insertInner(lst,itemData.Name)
    }
...
List.prototype.createRegular = function (itemData, options) {
  ...
  if (options.image) {
    ...
    sb.sb_addProperty(fm, 'class', 'hr-fl-size-xx-bg  mg-bottom-fd-sm pos-rel'); // sb.sb_addProperty(fm,'id',ct+'-form')
...
List.prototype.updateCart = function (ev) {
  var sb = this.sb; // console.log('The input event')
  // console.log(ev)
...
List.prototype.getters = {
  viewAttribs: (void 0).viewAttribs,
