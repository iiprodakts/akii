...
Modal.prototype.getParent = function (options) {
  ...
  sb.sb_addProperty(parent, 'data-modal', 'data'); //    if(options.opacity){
...
Modal.prototype.createModalHead = function () {
  ...
  text ? sb.sb_addProperty(btn, 'classs', 'modal-close-btn') : sb.sb_addProperty(btn, 'classs', 'modal-close-btn');
  return {
    head: head,
    open: btn
  };
...
Modal.prototype.createModalBody = function (content) {
  ...
  sb.sb_addChild(body, content); //    switch(options.size){
  //    	  case 1:{
  //    	  }
  //    }
